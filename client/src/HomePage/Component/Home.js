      ...
      <div id='main'>
        <div className='homepage'>
          ...
          <div className='introduction'>
            <h1 className='manage'>
              Mọi thứ
              <div id='_manage'>bạn cần cho việc</div> quản lí sinh viên</h1>
            <div className='manage_1'>Classe 369</div>
            <p id='_intro1'>
              Classe369 là 1 phần mềm tiện ích giúp quản lý sinh viên một cách ngắn gọn và đầy đủ nhất thông qua những thống kê xác thực nhất và
              nhanh nhất
            </p>
